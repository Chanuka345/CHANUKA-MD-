            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "𝘾𝙃𝘼𝙉𝙐𝙆𝘼 | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *ᴄʜᴀɴᴜᴋᴀ *\n\n> ᴄʜᴀɴᴜᴋᴀ ᴍᴅ"
                }, {
                  'quoted': _0x171143
                });
              } else {
